          ...
          {!selectedInvoice ? (
            ...
            <div className="max-w-md mx-auto bg-white dark:bg-bg-dark border border-neutral-250 dark:border-neutral-800 rounded-3xl p-6 shadow-xl space-y-6 animate-scale-up relative">
              ...
              <div className="border-t border-neutral-200 dark:border-neutral-800 pt-3 space-y-1.5 text-xs text-neutral-500 font-semibold">
                ...
                <div className="flex justify-between"><span>Taxes (5% GST):</span><span>₹{selectedInvoice.tax}</span></div>
                <div className="flex justify-between"><span>Service Charges (2.5%):</span><span>₹{selectedInvoice.serviceCharge}</span></div>
                    ...
                    printW.document.write(`
                      <html>
                        ...
                        <body>
                          ...
                          `).join('')}
                          <div class="divider"></div>
                          <div class="line"><span>Subtotal:</span><span>₹${selectedInvoice.subtotal}</span></div>
                          <div class="line"><span>Taxes (5%):</span><span>₹${selectedInvoice.tax}</span></div>
                          <div class="line"><span>Service Charge (2.5%):</span><span>₹${selectedInvoice.serviceCharge}</span></div>
                          <div class="bold line" style="font-size:14px;"><span>Total:</span><span>₹${selectedInvoice.total}</span></div>
                          <div class="divider"></div>
